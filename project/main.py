...
def mission_actions():
    ...
    return render_template('mission_action.html', missions=missions, page_title=page_title, title=title)
...
def mission_mcqs():
    ...
    return render_template('mission_mcq.html', quizzes=quizzes, page_title=page_title, title=title)
